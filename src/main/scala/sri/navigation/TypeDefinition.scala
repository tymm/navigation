...
@ScalaJSDefined
trait NavigationRoute[Params <: js.Object] extends ScreenClass {
...
object NavigationScreenOptionsImplicits {
  ...
  implicit def ftoJSF12[T <: js.Object, R](
      in: scala.Function2[NavigationScreenProp[NavigationRoute[T]],
                          js.Object,
                          R]): OptionalParam[NavigationScreenOption[R, T]] = {
    in: js.Function2[NavigationScreenProp[NavigationRoute[T]], js.Object, R]
  }

  implicit def ftoJSF123[T <: js.Object, R](
      in: scala.Function3[NavigationScreenProp[NavigationRoute[T]],
                          js.Object,
                          U[NavigationRouter],
                          R]): OptionalParam[NavigationScreenOption[R, T]] = {
    in: js.Function3[NavigationScreenProp[NavigationRoute[T]],
                     js.Object,
                     U[NavigationRouter],
                     R]
  }
...
@ScalaJSDefined
trait NavigationProp[S, A] extends js.Object {
  val state: S
  val dispatch: NavigationDispatch[A]
}

@js.native
trait NavigationScreenProp[S <: ScreenClass] extends js.Object {
  ...
  def setParams(newParams: S#ParamsType): Boolean = js.native
}

@ScalaJSDefined
trait NavigationNavigatorProps extends js.Object {
  val navigation: NavigationProp[NavigationState, NavigationAction]
}
